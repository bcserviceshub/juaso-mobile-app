...
import 'package:juaso_mobile_app/core/helper/helper.dart';
import 'package:juaso_mobile_app/core/network/logger_interceptor.dart';
...
class DioNetwork {
  ...
  static void initDio() {
    ...
    retryAPI = Dio(baseOptions(baseUrl));
